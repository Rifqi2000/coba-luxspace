        ...
        <div class="flex flex-wrap my-4 md:my-12">
          ...
          <div class="flex-1 px-4 md:p-6">
            ...
            <form action="{{ route('cart-add',$product->id) }}" method="POST">
              @csrf
              <button class="transition-all duration-200 bg-pink-400 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex" type="submit">
              <svg
